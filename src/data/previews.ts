...
export const PREVIEW_BY_ID: Record<string, PreviewMeta> = {
  ...
  'pd-streetwear': { previewUrl: U('photo-1523398002811-999ca8bac13f') },
  ...
  'pd-soft-gaze': { previewUrl: U('photo-1531123897727-8f129e168092') },
  ...
  'sc-rainy-window': { previewUrl: U('photo-1428592933017-aad5006962bc') },
  ...
  'comp-rule3': { previewUrl: U('photo-1506905925346-21bda4d32df4') },
  'comp-centered': { previewUrl: U('photo-1618005182384-a83a8bd57fbe') },
  'comp-profile': { previewUrl: U('photo-1531746020798-e6953c6e8e04') },
  'comp-silhouette': { previewUrl: U('photo-1492691527719-9d1e07e534b4') },
  ...
  'lit-practical': { previewUrl: U('photo-1524484487855-3bfad132ac82') },
  ...
  'cg-cyberpunk': { previewUrl: U('photo-1519609425065-af935449219c') },

  // —— Atmosphere ——
  'atm-rain': { previewUrl: U('photo-1428592933017-aad5006962bc') },
  'atm-fog': { previewUrl: U('photo-1483728642387-6c3bdd6cf93b') },
  'atm-dust': { previewUrl: U('photo-1464822759023-fed622ff2c3b') },
  'atm-snow': { previewUrl: U('photo-1418985991508-e47343d2af7f') },
  ...
  'mood-mysterious': { previewUrl: U('photo-1483728642387-6c3bdd6cf93b') },
  'mood-elegant': { previewUrl: U('photo-1496747611176-843222e1e57c') },
  'mood-cozy': { previewUrl: U('photo-1495474472287-4d71bcdd2085') },
  'mood-futuristic': { previewUrl: U('photo-1519609425065-af935449219c') },
  ...
  'mood-tense': { previewUrl: U('photo-1509248960155-d4159593b5ee') },
  ...
  'act-walk': { previewUrl: U('photo-1502781252888-51485ccb2785') },
  ...
  'act-lookaway': { previewUrl: U('photo-1531123897727-8f129e168092') },
  ...
  'sub-senior': { previewUrl: U('photo-1566616213894-2f6e1473bd63') },
  ...
  'pd-wet-hair': { previewUrl: U('photo-1428592933017-aad5006962bc') },
  ...
  'sc-elevator': { previewUrl: U('photo-1565008447742-97f4562adcd5') },
  ...
  'sc-market-alley': { previewUrl: U('photo-1555939596-8e9c5d4b0b5d') },
  ...
  'sc-snow-street': { previewUrl: U('photo-1418985991508-e47343d2af7f') },
  ...
  'comp-overshoulder': { previewUrl: U('photo-1485846234645-a62644f84728') },
  'comp-pov': { previewUrl: U('photo-1512941937669-90a1b58e7e9c') },
  'comp-reflection': { previewUrl: U('photo-1428592933017-aad5006962bc') },
  'comp-frame-in-frame': { previewUrl: U('photo-1497366216548-37526070297c') },
  'comp-neg-space': { previewUrl: U('photo-1618005182384-a83a8bd57fbe') },
  'comp-macro': { previewUrl: U('photo-1490750967868-88aa4486c946') },

  'comp-ecu': { previewUrl: U('photo-1529626455594-4ff0802cfb7e') },
  'comp-medium-close': { previewUrl: U('photo-1534528741775-53994a69daeb') },
  'comp-cowboy': { previewUrl: U('photo-1509631179647-0177331693ae') },
  'comp-long': { previewUrl: U('photo-1449824913935-59a10b8d2000') },
  'comp-extreme-wide': { previewUrl: U('photo-1506905925346-21bda4d32df4') },
  'comp-birds-eye': { previewUrl: U('photo-1477959858617-67f85cf4f1df') },
  'comp-high': { previewUrl: U('photo-1480714378408-67cf0d13bc1b') },
  'comp-worms-eye': { previewUrl: U('photo-1492144534655-ae79c964c9d7') },
  'comp-dutch': { previewUrl: U('photo-1485846234645-a62644f84728') },
  'comp-golden': { previewUrl: U('photo-1506905925346-21bda4d32df4') },
  'comp-leading': { previewUrl: U('photo-1449824913935-59a10b8d2000') },
  'comp-diagonal': { previewUrl: U('photo-1519501025264-65ba15a82390') },
  'comp-symmetry': { previewUrl: U('photo-1497366216548-37526070297c') },
  'comp-3quarter': { previewUrl: U('photo-1488426862026-3ee34a7d66df') },
  'comp-back': { previewUrl: U('photo-1492691527719-9d1e07e534b4') },
  ...
  'comp-selfie': { previewUrl: U('photo-1512941937669-90a1b58e7e9c') },
  'comp-crowded': { previewUrl: U('photo-1519501025264-65ba15a82390') },
  'comp-flatlay': { previewUrl: U('photo-1515562141207-7a88fb7ce338') },
  'comp-split': { previewUrl: U('photo-1618005182384-a83a8bd57fbe') },
  'comp-foreground': { previewUrl: U('photo-1441974231531-c6227db76b6e') },
  'comp-through': { previewUrl: U('photo-1470071459604-3b5ec3a7fe05') },
  'comp-tracking-frame': { previewUrl: U('photo-1485846234645-a62644f84728') },
  'comp-vertical': { previewUrl: U('photo-1524504388940-b1c1722653e1') },
  'comp-horizontal': { previewUrl: U('photo-1477959858617-67f85cf4f1df') },
  'comp-square': { previewUrl: U('photo-1618005182384-a83a8bd57fbe') },
  ...
  'lit-gel-magenta': { previewUrl: U('photo-1519609425065-af935449219c') },
  'lit-gel-cyan': { previewUrl: U('photo-1519501025264-65ba15a82390') },
  'lit-lightning': { previewUrl: U('photo-1509248960155-d4159593b5ee') },
  ...
  'mood-uneasy': { previewUrl: U('photo-1483728642387-6c3bdd6cf93b') },
  'mood-humor': { previewUrl: U('photo-1529626455594-4ff0802cfb7e') },
  'mood-sacred': { previewUrl: U('photo-1464822759023-fed622ff2c3b') },
  'mood-hiphop': { previewUrl: U('photo-1523398002811-999ca8bac13f') },
  'mood-asmr': { previewUrl: U('photo-1495474472287-4d71bcdd2085') },
  'mood-thriller': { previewUrl: U('photo-1509248960155-d4159593b5ee') },
  ...
  'cg-magenta-cyan': { previewUrl: U('photo-1519609425065-af935449219c') },
  ...
  'act-walk-rain': { previewUrl: U('photo-1428592933017-aad5006962bc') },
  'act-body-roll': { previewUrl: U('photo-1508700115892-45ecd05ae2ad') },
  'act-breathe': { previewUrl: U('photo-1531123897727-8f129e168092') },
  'act-turn-walk': { previewUrl: U('photo-1502781252888-51485ccb2785') },
